...
import { IPythonMode } from "pyright-internal-browser/src/analyzer/sourceFile";
import { PyrightServer } from "pyright-internal-browser/src/server";
...
export class PyrightLanguageProvider extends PyrightServer {
  ...
  constructor(
    ...
    super({ ...connection, listen() {} } as LSPAny);
